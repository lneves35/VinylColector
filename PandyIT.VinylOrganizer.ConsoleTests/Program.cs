    ...
    internal class Program
    {
        ...
        private static void BootstrapDiscogs()
        {
            ...
            using (var uow = new UnitOfWork(ctx))
            {
                ...
                {
                    oAuth = DiscogsAdapter.Authenticate(Console.ReadLine);
        ...
        private static void Main(string[] args)
        {
            ...
            using (var uow = new UnitOfWork(ctx))
            {
                var parsingService = new ParsingService(discogsAdapter);
        ...
        {
            var discogsId = service.ParseTextLineToDiscogsId("Dj Normal 4 - Water Delusion");
        }
